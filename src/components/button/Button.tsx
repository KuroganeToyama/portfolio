...
const Button = ({ label, path }: ButtonProps) => {
  return (
    <a href={path}>
      <button className="group relative flex w-fit items-center justify-center overflow-hidden rounded-md bg-green-400 text-zinc-800  px-4 py-2 font-bold transition-transform ease-out  hover:scale-105">
